...
// Tacked on to let javascript peek into the block buffer
block_t *plan_get_block(uint8_t n);

// Tacked on to let javascript peek into the block buffer
uint8_t plan_get_block_buffer_length();

// Tacked on to let javascript peek into the block buffer
uint8_t plan_get_block_buffer_head();

// Tacked on to let javascript peek into the block buffer
uint8_t plan_get_block_buffer_tail();
